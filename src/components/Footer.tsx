...
const Footer: React.FC = () => {
  ...
  return (
    <motion.footer 
      className="py-12 px-6 md:px-12 border-t border-white/10"
      initial="hidden"
      whileInView="visible"
      viewport={{ once: true }}
    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between gap-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <motion.div variants={itemVariants}>
              <h3 className="font-semibold mb-4 text-lg">קישורים</h3>
              <ul className="space-y-3">
                <li><Link to="/" className="text-gray-400 hover:text-aidea-green transition-colors">בית</Link></li>
                <li><Link to="/about" className="text-gray-400 hover:text-aidea-green transition-colors">מי אנחנו</Link></li>
                <li><Link to="/consulting" className="text-gray-400 hover:text-aidea-green transition-colors">קביעת ייעוץ</Link></li>
              </ul>
            </motion.div>
            
            <motion.div variants={itemVariants}>
              <h3 className="font-semibold mb-4 text-lg">צור קשר</h3>
              <ul className="space-y-3">
                <li className="text-gray-400">info@aidea.co.il</li>
                <li className="text-gray-400">073-123-4567</li>
                <li className="text-gray-400">תל אביב, ישראל</li>
              </ul>
            </motion.div>
            
            <motion.div variants={itemVariants}>
              <h3 className="font-semibold mb-4 text-lg">עקבו אחרינו</h3>
        ...
        >
          <p>© {new Date().getFullYear()} AIDEA. כל הזכויות שמורות.</p>
        </motion.div>
      </div>
    </motion.footer>
  );
